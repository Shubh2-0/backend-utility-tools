...
Real, deployable projects. Mine included [Chatterbox (Spring Boot WebSockets)](https://github.com/Shubh2-0/Chatterbox) and a [Shopzilla e-commerce backend](https://github.com/Shubh2-0/Shopzilla-Online-Shopping-Platform).
...
I built side projects on weekends. [SnapResize](https://github.com/Shubh2-0/SnapResize), [TIC_TAC_TOE with JavaFX](https://github.com/Shubh2-0/TIC_TAC_TOE_Game_With_JAVAFX), and [WorkFolio](https://github.com/Shubh2-0/WorkFolio) — these became my real portfolio.
...
HackerRank, LeetCode (easy/medium). I have an [Intermediate badge for Java on HackerRank](https://www.hackerrank.com/profile/shubhambhati226) — earned by daily practice.
...
3. **Get a working website.** Mine is at [shubh2-0.github.io](https://shubh2-0.github.io). It pulls more recruiter messages than my LinkedIn.
...
I'm currently exploring backend engineering roles — remote, hybrid, or relocation — with companies building products that scale. If you're hiring or know someone who is, my [LinkedIn](https://linkedin.com/in/bhatishubham) is the fastest way to reach me.
